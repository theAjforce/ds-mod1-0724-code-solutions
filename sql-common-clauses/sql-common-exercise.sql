...
SELECT id, resource_type FROM resource_type ORDER BY 1, 2 DESC;
...
SELECT id, log_feature, volume FROM log_feature WHERE log_feature = 'feature 201' AND volume > 100 AND volume < 300;
